...
export class ConversationService {
  ...
  async create(
    ...
    const greetingPrompt =
      ...
      `[중요] "오늘 하루 어땠어?"·"지금까지 어떻게 보내고 있어?"처럼 막막하고 포괄적인 질문은 피한다 — ` +
      `유저가 곧바로 한 마디로 답할 수 있는, 작고 구체적인 질문 하나만 던진다. ` +
      `지금 이 시각에 자연스러운 장면을 짚어 물어라(예: 늦은 밤이면 "이제 하루 마무리하는 중이야? 저녁은 뭐 먹었어?", ` +
      `퇴근 무렵이면 "오늘 일은 잘 마쳤어?", 낮이면 "점심은 먹었어? 오전엔 뭐 하면서 보냈어?"처럼 구체적으로). 1~2문장으로 짧게.`;
